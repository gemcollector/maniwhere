...
_CONFIG_FILE_NAME = 'franka/reach_dex.json'

def franka_reach_dex(time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
...
class Physics(RandPhysics):
    def end_to_target(self):
        ...
        end_to_target = data.site_xpos['object_site'] - data.site_xpos['tcp_site']
...
class Reach(BaseTask):
    ...
    def __init__(
        self,
        target_low=(0.6, -0.15, 0.176),
        target_high=(0.8, 0.15, 0.176),
        random=None,
        action_delay=0
    ):
